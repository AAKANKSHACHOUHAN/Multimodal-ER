...
df = pd.read_csv(r'/home/r_m727/All_Files/Corpus/Simulated/RAVDESS/RAVDESS_Librosa_Clean.csv', header=0, index_col=0)
...
y_less = df_less.iloc[0:1152, 62].values
# Extract features of majority classes.
X_less = df_less.iloc[0:1152, list(range(62))].values
print(y_less)
...
fig = plt.figure()
plot_confusion_matrix(confmat, class_names, title='SVM_Custom_RAVDESS_Clean')
#plt.show()

# Save plot as PNG file
fig.savefig('Confusion_Matrix_SVM_Librosa_RAVDESS_Clean.png')
